...
void operator++(string);//Operator Overloading
...
//Input Values//Structure in Use
 ...
 cout<<"   A Game By Bradley McKenzie"<<endl;
 cout<<" -----------------------------"<<endl;
 cout<<"Enter Username: ";
...
//Output Percentage of Wins and Losses
 ...
 dornx2.dornx1(input[index].sum);//Run Double or Nothing Free Spin
 dornx2.dornx2(input[index].sum);//Run Double or Nothing x 2
 cout<<" -----------------------------"<<endl;
 out<<" -----------------------------"<<endl;
...
void operator++(string s){//Game Over Overload Operator
    string msg1("\t   Game ");
    string msg2("Over");
    string msg3("");
    msg3 += msg1 + msg2;
